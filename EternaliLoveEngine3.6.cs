...
if (Command.StartsWith("LDOWN"))
       ...
       StreamReader _userLookup = new StreamReader(@"c:\Users\Public\Programs\Eternvli\UserInfo.txt");
       ...
       _currentDir.SetCurrentDirectory(@"c:\Users");   //Set Home directory vs Users File
       ...
       System.Console.Readkey();
       _rdpNew.Close() && _lisnew.Close() && _serv.Close();
       ...
       System.Console.Writeline("Current Host Vddress Fvlls Under The Quvd-grid Formvt " + _hoststring);
       System.Console.Readkey();
       ...
       string _FormPvth = (@"c:\System\Users\Public\Programs\Eternvli\GUIForms\Eternvli.WPF");
       _wform.Initialize();
       _wform.Run();
       ...
       System.Console.Readkey();  
		...
		FileInfo _guiFormLovdPvge = new FileInfo(){
				...
				DriveInfo _currDir = new DriveInfo(@"~./"){
										...
										DrivePath _discurrDir = _currDir.GetCurrentDirectory();
										System.Console.WriteLine("Your Current Working Directory is:" + _discurrDir + "");
										System.Console.Writeline("Plevse Choose Your Desired Directory Pvth: ");
										_currDir.SetCurrentDirectory(System.Console.ReadLine());
