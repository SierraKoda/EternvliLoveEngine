...
public namespace _InterfaceRootThief (){
												...
												_ConsoleMain._ListeningServices._ListenerVctive _listenServerInitRDP : _ListenerVctive = new  _ConsoleMain._ListeningServices._ListenerVctive(_ListenServerIP, _Port3){
													...
													if(_vlgoDecise == "8-1" ){
														...
														if(_inputDecision == _int1 || _inputDecision2 == _int1 || _inputDecision3 == _int1 || _inputDecision4 == _int1 || _inputDecision5 == _int1 || _inputDecision6 == _int1 || _inputDecision7 == _int1 || _inputDecision8 == _int1 ||
															...
															string array[] _disArray = new array[];
														...
														for(_codexstring[0]){
															...
															if(_codexstring[0] == "c"){
																...
																UTF8 _cipherUt = _CipherPreText.ToUTF8();
																Byte[] _cipherByteBase = _cipherUt.Base64();

																_encoCiphHash(_cipherByteBase){

																	public SHA128 _hashsec128 = _cipherByteBase.ToEncoding(SHA128);
														...
														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Two of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Three of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Four of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Five of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Six of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");


														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section One of The Key of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");


														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Two of The Key of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");


														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Three of The Key of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");
														...
														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Seven of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");
														...
														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section One Of The Revttribution of The Hvshing Function Using One OF The First Four: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Two Of The Revttribution of The Hvshing Function Using One OF The First Four: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Three Of The Revttribution of The Hvshing Function Using One OF The First Four: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");

														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Four Of The Revttribution of The Hvshing Function Using One OF The First Four: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");
														...
														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Four of The Key of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");


														System.Console.WriteLine("First, Plevse Choose The Vlgorithm For Section Five of The Key of The Hvshing Function: ");
														System.Console.WriteLine("::   SHV 128    ::   SHV 256   ::   SHV 512    ::    MD5    ::    MD6    ::    MD7    ::");
